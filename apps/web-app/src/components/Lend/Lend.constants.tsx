...
export const assets: IAsset[] = [
  {
    ...
    apy: '11.34%',
    icon: <img src={iconBtc} alt="BTC" className="w-9 h-9" />,
    isHighApy: true,
    isSortable: true,
  },
  {
    ...
    apy: '12.34%',
    icon: <img src={iconSov} alt="SOV" className="w-9 h-9" />,
    isHighApy: true,
    isSortable: true,
  },
  {
    ...
    apy: '13.34%',
    icon: <img src={iconWbtc} alt="wBTC" className="w-9 h-9" />,
    isSortable: false,
  },
  {
    symbol: 'BOS',
    ...
    apy: '14.34%',
    icon: <img src={iconBos} alt="BOS" className="w-9 h-9" />,
    isHighApy: true,
    isSortable: true,
  },
  {
    ...
    apy: '15.34%',
    icon: <img src={iconTether} alt="USDT" className="w-9 h-9" />,
    isSortable: true,
  },
];
