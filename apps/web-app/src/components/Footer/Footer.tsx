export const Footer = () => {
  return (
    <footer className="w-full pt-9 pb-12 mt-10 px-4 flex flex-row gap-4 justify-start text-center text-sm text-black dark:text-slate-500 border-t border-t-stone-200 dark:border-t-stone-800">
